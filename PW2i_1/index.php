    ...
    <body>
        <div class="row mt-4">
            <div class="col-lg-6 ml-2">
                <h1>Ständige Befölkerung Thurgau</h1>
            ...
            <div class="col-lg-2">
                ...
                <div class="form-group row">
                    ...
                    <form name="myForm" id="myForm" style="width: 100%" action="" method="post">
                        ...
                        <select class="form-control form-control mb-4" name="Altersklasse" id="Altersklasse">
                            <option>Altersklassen</option>

                            <option>4 Jahre oder jünger</option>
                            <option>05 bis 09 Jahre</option>
                            ...
                            <option>90 Jahre oder älter</option>
                        </select>
...
$(document).ready(function(){
     $("#myForm").submit();
            ...
            <?php
                //error_reporting(0);
            	// Code für das Abspeichern der Eingabe des Benutzers.
            ...
            <div class="col-lg-3">
                ...
                <div class="input-group my-2 mb-4">
                    ...
                    <input type="text" class="form-control" name="rAltersklassen" value="<?php
